...
class PrePublishHook(Hook):
    ...
    def execute(self, tasks, work_template, progress_cb, **kwargs):
        ...
        for task in tasks:
            ...
            elif output["name"] == "baking_image":
                errors.extend(self.__validate_item_for_baking_image_publish(item))
            else:
    ...
    # validate baking images...
    def __validate_item_for_baking_image_publish(self, item):
        """
